    ...
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-8 w-full">
        ...
        <ItemLayout className="col-span-6 !p-0">
          <img
            className="w-full h-auto"
            src="https://github-readme-stats.vercel.app/api/pin/?username=mannubhai1&repo=Sankalp&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false&description_lines_count=2"
            alt="Mannubhai1"
            loading="lazy"
          />
        </ItemLayout>
